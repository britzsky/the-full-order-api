...
@Mapper public interface ProcurementCrudMapper {
 List<Map<String,Object>> analysis(Map<String,Object>p); List<Map<String,Object>> carts(Map<String,Object>p); List<Map<String,Object>> cartItems(Map<String,Object>p);
